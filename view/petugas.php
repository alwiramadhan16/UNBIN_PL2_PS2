...
?>
        ...
        <h2>Data Akses Petugas</h2>
        <h4><a href="Views/View_post_petugas.php">Tambah Petugas</a></h4>
                ...
                if(isset($GetPetugas))
                {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="Config/Routes_Petugas2.php?function=delete_petugas&id_petugas=<?php echo $Get['id_petugas'] ?>" onclick="return confirm('Apakah anda mau menghapus data ini?')">Hapus</a>
                            </td>
                        </tr>
                        <?php 
                        }
